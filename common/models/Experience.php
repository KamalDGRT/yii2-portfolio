...
class Experience extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['exp_name', 'duration'], 'string', 'max' => 100],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\ExperienceQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\query\ExperienceQuery(get_called_class());
    }
}
